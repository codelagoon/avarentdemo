...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]" data-testid="login-screen">
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              {errorMessage && (
                <p className="animate-element text-sm text-red-400 text-center -mt-1">{errorMessage}</p>
              )}
