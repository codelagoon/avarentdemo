...
class AuditPacketService {
  ...
  exportPacketAsText(packet: AuditPacket): string {
    return `
================================================================================
                    AVARENT MERIDIAN - REGULATORY AUDIT PACKET
================================================================================
...
Generated by AVARENT Meridian Automated Compliance System
...
`.trim()
  ...
  private generateExecutiveSummary(
    ...
    return `Over the 90-day reporting period, AVARENT Meridian processed ${ledgerStats.total} lending decisions 
...
This certifies that AVARENT Meridian has conducted a comprehensive search for
        ...
        ledgerCertificates: [
          {
            ...
            verifier: "AVARENT Meridian Sealed Ledger",
