  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-slate-950 text-white">
      <div className="flex flex-col items-center gap-2">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-status-fail-bg">
          <svg className="h-6 w-6 text-status-fail" fill="none" viewBox="0 0 24 24" stroke="currentColor">
